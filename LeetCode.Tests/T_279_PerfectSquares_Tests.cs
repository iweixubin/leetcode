...
namespace LeetCode
{
    public class T_279_PerfectSquares_Tests
    {
        const int X12 = 12;
        const int X13 = 13;
        ...
        [Theory]
        [InlineData(T_279_PerfectSquares_Tests.X12)]
        [InlineData(T_279_PerfectSquares_Tests.X13)]
        [InlineData(T_279_PerfectSquares_Tests.X8328)]
        [InlineData(T_279_PerfectSquares_Tests.X7929)]
        [InlineData(T_279_PerfectSquares_Tests.X5374)]
        [InlineData(T_279_PerfectSquares_Tests.X34567)]
